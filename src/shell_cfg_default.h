...
#ifndef __SHELL_CFG_DEFAULT_H__
#define __SHELL_CFG_DEFAULT_H__

/**
 * 如果编译器支持`__has_include`,那么`shell_cfg.h`是可选；
 * 否则必须在自己工程中添加`shell_cfg.h`以保证所有宏都已按需定义
 */
#if defined __has_include
#if __has_include("shell_cfg.h")
#include "shell_cfg.h"
#endif
#else
#include "shell_cfg.h"
